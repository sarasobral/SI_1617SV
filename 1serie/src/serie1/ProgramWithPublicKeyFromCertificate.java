...
import code.serie2.ex6.AesSecretKey;
 ...
 */
public class ProgramWithPublicKeyFromCertificate {
    ...
    public static void main(String[] args) throws Exception {
       ...
       /*o  Encrypt the CEK with the recipient's public key using the RSAES-
        ...
        byte[] encryptedKeyBytes = RsaKey.encript(pk, aesKey);
        ...
        String protectedHeader = new Tag(pk.getAlgorithm()+"-OAEP",
                aesKey.getAlgorithm().charAt(0)+""+aesKey.getEncoded().length*8+AesSecretKey.ALGORITHM_CIPHER).getTag();
