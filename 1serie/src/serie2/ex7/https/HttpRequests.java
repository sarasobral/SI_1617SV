...
public class HttpRequests {
     ...
     * @param connection connectionToSql to add the properties to
     ...
     * Adds the properties to the connectionToSql
     * @param connection connectionToSql to add the properties to
     * @param urlProperties properties to add
     */
    ...
    /**
     * Retrieves the response of the connectionToSql
     * @param connection connectionToSql used
    ...
    /**
     * Writes the bodyContent to the connectionToSql
     * @param con connectionToSql to write the properties to
